 ...
 *  *****************************************************************************
 */
package com.qq.googleplay.ui.animation.recyclerviewanim.animator.helper;
...
public class ViewAnimator {
    ...
    /**
     * Creates StorageVolume new ViewAnimator, using the given {@link RecyclerView}.
     *
    ...
    /**
     * Sets the delay in milliseconds before an animation of StorageVolume view should start. Defaults to {@value #DEFAULT_ANIMATION_DELAY_MILLIS}.
     *
     * @param delayMillis the time in milliseconds.
     */
    ...
    /**
     * Returns StorageVolume Parcelable object containing the AnimationAdapter's current dynamic state.
     */
    @NonNull
