...
public class NewBadgeView extends TextView {
    ...
    private void init() {
        ...
        setBackground(9, Color.parseColor("#fd4a48"));
        setGravity(17);
        setHideOnNull(true);
        setBadgeCount(0);
    }
    ...
    public void setBackground(int dipRadius, int badgeColor) {
        ...
        ShapeDrawable bgDrawable = new ShapeDrawable(new RoundRectShape(new float[]{(float) radius,
                (float) radius, (float) radius, (float) radius, (float) radius, (float) radius,
                (float) radius, (float) radius}, null, null));
