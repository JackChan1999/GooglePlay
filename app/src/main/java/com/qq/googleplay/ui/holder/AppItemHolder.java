 ...
 * Package_Name：com.qq.googleplay.ui.holder
 * Version：1.0
 * time：2016/10/19 18:36
 * des ：${TODO}
 * gitVersion：$Rev$
 * updateAuthor：$Author$
 * updateDate：$Date$
 ...
 * ============================================================
 **/
public class AppItemHolder extends BaseViewHolder<AppInfoBean> implements
    ...
    public static AppItemHolder get(Context context, View convertView,
                                    ViewGroup parent, int layoutId, int position) {
        if (convertView == null) {
            View itemView = LayoutInflater.from(context).inflate(layoutId, parent, false);
            AppItemHolder holder = new AppItemHolder(context, itemView, parent, position);
            holder.mLayoutId = layoutId;
            return holder;
        } else {
            AppItemHolder holder = (AppItemHolder) convertView.getTag();
