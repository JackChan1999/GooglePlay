package com.github.commons.assist;
...
import com.github.commons.utils.ShellUtil;
...
public class SilentInstaller {
    ...
    public int uninstallSilent(Context context, String packageName, boolean isKeepData) {
        ...
        ShellUtil.CommandResult commandResult = ShellUtil.execCmd(command.toString(), !isSystemApplication(context), true);
    ...
    public int installSilent(Context context, String filePath, String pmParams) {
        ...
        ShellUtil.CommandResult commandResult = ShellUtil.execCmd(command.toString(),
    ...
    public int getInstallLocation() {
        ShellUtil.CommandResult commandResult = ShellUtil.execCmd(
