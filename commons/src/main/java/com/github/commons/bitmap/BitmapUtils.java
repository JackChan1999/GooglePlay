...
import com.github.commons.utils.FastBlur;
import com.github.commons.utils.MediaStoreUtil;
...
public class BitmapUtils {
    ...
    public static void blurAdvanced(Context context, Bitmap bkg, View view) {
        if (bkg != null) {
            ...
            overlay = FastBlur.doBlur(context,overlay, (int) 12.0f, true);
            if (Build.VERSION.SDK_INT >= 16) {
                view.setBackground(new BitmapDrawable(context.getResources(), overlay));
            } else {
                view.setBackgroundDrawable(new BitmapDrawable(context.getResources(), overlay));
    ...
    public static BitmapDrawable getBlur_2(Context context, Bitmap bkg) {
        ...
        paint.setFlags(Paint.FILTER_BITMAP_FLAG);
        canvas.drawBitmap(bkg, 0.0f, 0.0f, paint);
        return new BitmapDrawable(context.getResources(), FastBlur.doBlur(context,bitmap, (int) 1.0f, true));
    }
    ...
    public static void blur_3(Context context, Bitmap bkg, View view) {
        ...
        paint.setFlags(Paint.FILTER_BITMAP_FLAG);
        canvas.drawBitmap(bkg, 0.0f, 0.0f, paint);
        overlay = FastBlur.doBlur(context,overlay, (int) 100.0f, true);
        if (Build.VERSION.SDK_INT >= 16) {
            view.setBackground(new BitmapDrawable(context.getResources(), overlay));
        } else {
            view.setBackgroundDrawable(new BitmapDrawable(context.getResources(), overlay));
    ...
    public static void star_blur(Context context, Bitmap bm, ImageView iv) {
        ...
        imageView.setImageDrawable(new BitmapDrawable(context.getResources(), FastBlur.doBlur(context,overlay,
                (int) 5.0f, true)));
    }
